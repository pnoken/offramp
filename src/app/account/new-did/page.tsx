...
const NewSeedPhrase: React.FC = () => {
  ...
  const createDownloadLink = () => {
    ...
    const blob = new Blob([JSON.stringify(customerDid, null, 2)], {
        ...
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 p-8 bg-gradient-to-br from-blue-500 to-purple-600 text-white">
              ...
              {customerDid && (
                <DownloadData onDownloadClick={createDownloadLink} />
              )}
              <motion.button
            ...
            <div className="md:w-1/2 p-8">
              <h3 className="text-2xl font-semibold mb-4 text-gray-800">
                What is a portable DID?
              </h3>
              <p className="text-gray-600 mb-4">
                A portable DID (Decentralized Identifier) is like a digital
                passport for your online identity. It&apos;s a unique string of
                characters that represents you in the decentralized web.
              </p>
              <p className="text-gray-600 mb-6">
                It&apos;s safe to use with Fiatsend wallet. Your DID is stored
                locally and never leaves your device without your explicit
                permission.
              </p>
