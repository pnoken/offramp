        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-8 space-y-6">
            ...
            <p className="text-gray-600">
              Drag and drop the JSON file you exported from DID:
            </p>
          ...
          <div className="md:w-1/2 bg-gray-50 p-8 space-y-6">
            ...
            <p className="text-gray-600">
              The did.json backup file stores your decentralized identifier
              (DID) information securely, encrypted with your account&apos;s
              password. This file acts as a secondary recovery method in
              addition to your private key, ensuring that your identity and data
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>
                When you create your account directly in the Fiatsend Wallet UI,
                you need to manually export the JSON file.
              </li>
              <li>
                For step-by-step instructions on how to manually export your
                did.json file from various interfaces, refer to our detailed
                guide.
              </li>
            </ul>
          </div>
